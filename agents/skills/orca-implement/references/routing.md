...
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | --------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Scouts                        | Codex `gpt-5.6-luna`                                                                                                   | `xhigh`                                       | —                                                                                 | read-only; Orca terminals in `<WT>`; one report per lens                                                                                                                                                     |
...
| Acceptance check              | Claude `opus`                                                                                                          | `high`                                        | `Codex gpt-5.6-sol` at `xhigh`                                                    | read-only; Orca terminal in `<WT>`; verifies each acceptance criterion against the integrated HEAD; one report per pass                                                                                      |
| Planner, `low`/`medium` tier  | Claude `fable`                                                                                                         | `high`                                        | coordinator drafts the plan                                                       | single planner; a complete plan from the brief; writes only its own draft file                                                                                                                               |
...
| Builder, `low` complexity     | Codex `gpt-6-astra`                                                                                                    | `low`                                         | `Codex gpt-5.6-sol` at `xhigh`                                                    |                                                                                                                                                                                                              |
| Builder, `medium`             | Codex `gpt-6-astra`                                                                                                    | `high`                                        | `Codex gpt-5.6-sol` at `xhigh`                                                    | default builder                                                                                                                                                                                              |
| Builder, `high`               | Codex `gpt-6-astra`                                                                                                    | `xhigh`                                       | `Codex gpt-5.6-sol` at `xhigh`                                                    | many-file or mechanically hard, but fully specified by plan + contracts                                                                                                                                      |
| Builder, `xhigh`              | Claude `fable`                                                                                                         | `xhigh`                                       | `Claude opus` at `xhigh`                                                          | the remaining reasoning is the risk: see the task complexity rubric                                                                                                                                          |
| Code reviewers                | Claude `fable` + Codex `gpt-6-astra`                                                                                   | `high` / `xhigh`                              | `Claude opus` for `fable`; `Codex gpt-5.6-sol` for `gpt-6-astra`; both at `xhigh` | both each round; round cap from `run_complexity`                                                                                                                                                             |
| Security reviewers            | Claude `fable` + Codex `gpt-6-astra`                                                                                   | `xhigh` / `xhigh`                             | `Claude opus` for `fable`; `Codex gpt-5.6-sol` for `gpt-6-astra`; both at `xhigh` | `medium` and above only; both in round 1, dispatched alongside the code reviewers; later rounds only on the Phase 7 security trigger; each runs the mapped security-review skill (`references/skill-map.md`) |
| Adversarial QA                | Cross-model to the builder of the highest-complexity merged task: Claude → Codex `gpt-6-astra`; Codex → Claude `fable` | `high` for `fable`; `xhigh` for `gpt-6-astra` | `Claude opus` for `fable`; `Codex gpt-5.6-sol` for `gpt-6-astra`; both at `xhigh` | `medium`/`high`/`xhigh` runs only; runs once after all code-review rounds and fixes; disposable worktree, branch never merged                                                                                |
